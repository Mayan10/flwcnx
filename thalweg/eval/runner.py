...
from thalweg.calibrate.baselines_online import GCACI, RollingRC
from thalweg.calibrate.conformal import fit_conformal
from thalweg.calibrate.heterogeneity import GatedCalibrator
...
from thalweg.decide.admission import evaluate_admission
from thalweg.decide.congestion import detect_congestion
...
from thalweg.eval.splits import check_no_leak, contiguous_82, temporal_split
from thalweg.forecast.baselines import build_baseline
from thalweg.forecast.starnet import StarNet, StarNetNoAttention, StarNetNoPeriodicalEmbedding
...
from thalweg.state.regime import (
    RegimeAssigner,
    presets_for,
)
...
def _environment() -> dict:
    ...
    from thalweg.device import describe_device, resolve_device
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Run the thalweg experiment grid.")
    ...
    from thalweg.config import DataConfig, FeatureConfig, SplitConfig, StarNetConfig
