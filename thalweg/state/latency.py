...
from thalweg.config import LATENCY_COL, PERIOD_SECONDS, TIME_COL
from thalweg.timeutil import to_epoch_seconds
...
def label_periods(
    ...
    *,
    ...
    # thalweg/timeutil.py, and the thirteen CI failures that found it.
