...
from thalweg.config import LATENCY_COL, NORMALIZED_COLUMNS, TARGET_COL, TIME_COL
...
def attach_geometry(
    ...
    **This is a reconstruction, not a measurement.** WetLinks does not record
    ...
    """
    from thalweg.ingest.spacetrack import elements_to_tles, latest_per_satellite
    from thalweg.ingest.tle import Observer, visible_counts
