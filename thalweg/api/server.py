#!/usr/bin/env python3
"""FastAPI server exposing the thalweg pipeline over WebSocket and REST.
...
Usage
-----
    python -m thalweg.api.server --mode synthetic --port 8000
    python -m thalweg.api.server --mode real --location canada --port 8000
"""
...
from thalweg.api.pipeline import PipelineSpec, TrainedPipeline, build_pipeline
...
def main(argv: list[str] | None = None) -> None:
    parser = argparse.ArgumentParser(
        description="Thalweg ML API server",
