...
|---|---|---|
| [`flwcnx/`](flwcnx) | **The package.** Ingest, features, forecast, calibration, decisions. | Python 3.11+, PyTorch |
| [`flwcnx/api/`](flwcnx/api) | Streams live decisions out of the real pipeline over WebSocket | FastAPI |
